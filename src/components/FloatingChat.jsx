...
// Note: intentionally excludes mild insults ('idiot', 'moron', 'ugly', 'trash', 'garbage',
// 'stupid', etc.) and internet slang ('wtf', 'lmfao') — those false-positive too easily on
// normal clinical chat and would trigger an unwarranted 15-minute lockout.
