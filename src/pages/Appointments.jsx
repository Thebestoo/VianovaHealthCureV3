...
import {
  ...
  AlertTriangle, ChevronDown, Bell, BellOff, Clock, MapPin,
          ...
          <div style={{ display: 'flex', border: '1px solid #e5e7eb', borderRadius: 8, overflow: 'hidden' }}>
            {['upcoming', 'past', 'all'].map(v => (
              <button key={v} onClick={() => setView(v)}
                style={{ padding: '7px 16px', fontSize: 13, fontWeight: view === v ? 700 : 400, background: view === v ? '#2563eb' : '#fff', color: view === v ? '#fff' : '#374151', border: 'none', cursor: 'pointer', textTransform: 'capitalize' }}>
